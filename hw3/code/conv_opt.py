...
class ArtistConvNet:
	...
	def define_tensorflow_graph(self, params):
		...
		layer1_filter_size = params['layer1_filter_size']
		layer1_depth = params['layer1_depth']
		layer1_stride = params['layer1_stride']
		layer2_filter_size = params['layer2_filter_size']
		layer2_depth = params['layer2_depth']
		layer2_stride = params['layer2_stride']
		layer3_num_hidden = params['layer3_num_hidden']
		layer4_num_hidden = params['layer4_num_hidden']
...
if __name__ == '__main__':
	...
	params['layer3_num_hidden'] = 400
	params['layer4_num_hidden'] = 128
