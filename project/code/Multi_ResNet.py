...
#Results
np.savetxt("MultiResNet_time.txt", [run_time])
np.savetxt("MultiResNet_training_loss.txt", l)
np.savetxt("MultiResNet_training_acc.txt", a)
np.savetxt("MultiResNet_test_acc.txt", aT)
...
plt.show()
plt.savefig("MultiResNet_training_loss.png")
...
plt.show()
plt.savefig("MultiResNet_training_accuracy.png")
...
plt.show()
plt.savefig("MultiResNet_testing_accuray.png")
