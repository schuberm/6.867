...
if __name__=='__main__':
	...
	for ii in range(10):
		vrandfool = numpy.random.randn(n)
		print numpy.linalg.norm(vrandfool)
		foolrate = Err(data0['X_train'],vrandfool)
		print foolrate
