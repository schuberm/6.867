...
def resUnit(input_layer,i):
    with tf.variable_scope("res_unit"+str(i)):
        ...
        output = input_layer + part6  # add simple connection
        return output
...
#Results
np.savetxt("ResNet_time.txt", [run_time])

np.savetxt("ResNet_training_loss.txt", l)
np.savetxt("ResNet_training_acc.txt", a)
np.savetxt("ResNet_test_acc.txt", aT)
...
plt.show()
plt.savefig("ResNet_training_accuracy.png")
...
plt.show()
plt.savefig("ResNet_testing_accuray.png")
