...
#Results
np.savetxt("HighwayNet10_time.txt", [run_time])

np.savetxt("HighwayNet10_training_loss.txt", l)
np.savetxt("HighwayNet10_training_acc.txt", a)
np.savetxt("HighwayNet10_test_acc.txt", aT)

plt.plot(l) # plot training loss
plt.xlabel("Steps")
plt.ylabel("Training Loss")
plt.title("HighwayNet Training Loss")
plt.savefig("HighwayNet10_training_loss.png")
plt.show()
...
plt.savefig("HighwayNet10_training_accuracy.png")
plt.show()
...
plt.savefig("HighwayNet10_testing_accuracy.png")
plt.show()
