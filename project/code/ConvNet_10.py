...
time1 = time.time()  #take record of start time
...
#Results
np.savetxt("ConvNet10_running_time.txt", [run_time])
np.savetxt("ConvNet10_training_loss.txt", l)
np.savetxt("ConvNet10_training_acc.txt", a)
np.savetxt("ConvNet10_test_acc.txt", aT)

plt.plot(l) # plot training loss
plt.xlabel("Steps")
plt.ylabel("Training Loss")
plt.title("ConvNet Training Loss")
plt.savefig("ConvNet10_training_loss.png")
plt.show()
...
plt.savefig("ConvNet10_training_accuracy.png")
plt.show()

plt.plot(aT) # plot test accuracy
plt.xlabel("Steps")
plt.ylabel("Testing Accuracy")
plt.title("ConvNet Testing Accuracy")
plt.savefig("ConvNet10_testing_accuracy.png")
plt.show()
