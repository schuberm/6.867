...
#Results
np.savetxt("ConvNet_running_time.txt", [run_time])
np.savetxt("ConvNet_training_loss.txt", l)
np.savetxt("ConvNet_training_acc.txt", a)
np.savetxt("ConvNet_test_acc.txt", aT)
...
plt.show()
plt.savefig("ConvNet_training_loss.png")
...
plt.show()
plt.savefig("ConvNet_training_accuracy.png")
...
plt.show()
plt.savefig("ConvNet_testing_accuray.png")
